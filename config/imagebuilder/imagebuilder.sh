...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        pigz ppp ppp-mod-pppoe proto-bonding pv rename resize2fs tar ttyd tune2fs \
        ...
        luci-lib-base luci-lib-ip luci-lib-ipkg luci-lib-jsonc luci-lib-nixio luci-mod-admin-full luci-mod-network \
